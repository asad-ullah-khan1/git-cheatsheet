...
| **git remote rename**        | The command is followed by the name of the remote repository and the new name to give it | `git remote rename origin new-origin` |
| **git remote -v**            | Allows to view the remotes associated with the local repository             | `git remote -v` |
| **git request-pull**         | Creates a summary of changes for your upstream to pull or generates a summary of pending changes for an email request  | Example 1: `git request-pull origin/main your-branch`<br>Example 2: `git request-pull <base> <head> <repository>` |
